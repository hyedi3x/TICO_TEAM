...
//     // 연령 선택 후 PASS 인증으로 리디렉션
//     const handleAgeSelect = (ageGroup) => {
//       setShowAgeModal(false); // 모달 닫기
  
//       // 백엔드 PASS API 시작 지점으로 리디렉션
//       const redirectUrl = `http://localhost:8081/pass/start?ageGroup=${ageGroup}`;
...
//           <div className="modal-content">
//             <h3>본인의 나이를 선택해주세요</h3>
//             <button onClick={() => handleAgeSelect("under14")}>14세 미만입니다</button>
//             <button onClick={() => handleAgeSelect("over14")}>14세 이상입니다</button>
//           </div>
//         </div>
//       )}
//     </div>
